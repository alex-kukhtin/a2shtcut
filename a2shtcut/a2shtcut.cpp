...
// forward
bool CreateLink(LPCWSTR szTarget, LPCWSTR szPath, LPCWSTR szName, LPCWSTR szWDir, int nIcon, LPCWSTR szDescr, LPCWSTR szArgs);
                     ...
                     int       nCmdShow)
{
	...
	if (cmd == _cmd_add) {
		if (!CreateLink(target, path, name, wdir, icon, descr, args)) {
			CString str;
